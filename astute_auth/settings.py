"""
Django settings for astute_auth project.
...
PROSPECT_EMAIL_FROM = os.environ['PROSPECT_EMAIL_FROM']
PROSPECT_EMAIL_FROM_NAME = os.environ['PROSPECT_EMAIL_FROM_NAME']
PROSPECT_EMAIL_SUBJECT = os.environ['PROSPECT_EMAIL_SUBJECT']
PROSPECT_EMAIL_BODY = os.environ['PROSPECT_EMAIL_BODY']
...
WSGI_APPLICATION = 'astute_auth.wsgi.application'
